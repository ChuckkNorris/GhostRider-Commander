...
namespace SimpleRest {
    ...
    public class SimpleRestClient {
        ...
        public void SendOneWayMessage(SimpleMessage restMessageToSend) {
            MessageSender.SendOneWayMessage(this, restMessageToSend);
        }

        //public IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress> SendMessageWithProgress<T>(SimpleMessage simpleMessage) {
        //    return MessageSender.SendMessageWithProgress<T>(this, simpleMessage);
